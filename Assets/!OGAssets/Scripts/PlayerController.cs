...
public class PlayerController : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    public void LinkAddByGrid(int gridX, int gridY)
    {
        ...
        if (tile.GetCurrentItem().type < 0) powerupsInLink.Add(tile.GetCurrentItem());
    ...
    public void LinkRemove(GridTile tile)
    {
        ...
        if (tile.GetCurrentItem().type < 0) powerupsInLink.Remove(tile.GetCurrentItem());
    ...
    public void ExecuteLink()
    {
        ...
        if (GameManager.instance.currentPlayer.photonView.IsMine)
        {
            ...
            if (powerupsInLink.Count > 1)
            {
                ...
                GameManager.instance.playerController.toast.SetToast(tileLink[tileLink.Count - 1].transform.position, "EXTRA MOVE!", new Color(1, 0.37f, 0.67f, 1));
            }
