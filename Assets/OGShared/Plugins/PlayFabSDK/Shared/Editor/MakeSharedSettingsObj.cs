...
public class MakeScriptableObject
{
    ...
    public static void MakePlayFabSharedSettings()
    {
        ...
        AssetDatabase.CreateAsset(asset, "Assets/OGShared/Plugins/PlayFabSdk/Shared/Public/Resources/PlayFabSharedSettings.asset"); // TODO: Path should not be hard coded
